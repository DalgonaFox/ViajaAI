...
> Este projeto foi criado como um exercício durante as aulas no curso Técnico em Desenvolvimento de Sistemas no SENAI. Foi utilizada uma API do GEMINI que é gratuita, e fui personalizando a aplicação conforme desejado.
